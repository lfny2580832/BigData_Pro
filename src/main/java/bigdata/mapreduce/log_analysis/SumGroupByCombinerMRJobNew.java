...
public class SumGroupByCombinerMRJobNew extends Configured implements Tool {
    ...
    public int run(String[] args) throws InterruptedException, IOException, ClassNotFoundException {
        ...
        job.setJarByClass(SumGroupByCombinerMRJobNew.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            int status = ToolRunner.run(conf,new SumGroupByCombinerMRJobNew(),args);
            System.exit(status);
        } catch (Exception e) {
            e.printStackTrace();
        }
